...
url = "https://ogcapi.bgs.ac.uk/collections/bgsgeology625kdykes/items?f=json&offset={}"
...
FEATURE_TYPE = "Dykes"
FEATURE_IRI = "http://data.bgs.ac.uk/id/geology625k/dykes/{}"
...
def generate():
    ...
    graph.serialize(
        "spatial/geologymap/dykes-features.nt", format="ntriples", encoding="utf-8"
    )
