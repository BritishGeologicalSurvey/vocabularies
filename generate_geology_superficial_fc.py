...
dataset_json_url = "https://ogcapi.bgs.ac.uk/collections/bgsgeology625ksuperficial?f=json"
url = "https://ogcapi.bgs.ac.uk/collections/bgsgeology625ksuperficial/items?f=json&offset=0"
...
def generate():
    ...
    graph.serialize(
        "spatial/geologymap/superficial-feature-collection.ttl", format="longturtle"
    )
