...
url = "https://ogcapi.bgs.ac.uk/collections/bgsgeology625ksuperficial/items?f=json&offset={}"

BGS = Namespace("http://data.bgs.ac.uk/id/")
GEOLOGY_MAP_DATASET = BGS.geology625k
FEATURE_COLLECTION_IRI = URIRef("http://data.bgs.ac.uk/id/geology625k/superficial")
FEATURE_TYPE = "Superficial"
FEATURE_IRI = "http://data.bgs.ac.uk/id/geology625k/superficial/{}"
...
def generate():
            ...
            for feature in features:
                ...
                if properties:
                    ...
                    if (
                        rcs is not None
                        and rcs != ""
                        and rcs != "NOT APPLICABLE"
                        and rcs != "CLAY + SILT + SANDU"
                    ):
                        graph.add(
                            (
                                iri,
    ...
    graph.serialize(
        "spatial/geologymap/superficial-features.nt",
        format="ntriples",
        encoding="utf-8",
    )
