...
dataset_json_url = "https://ogcapi.bgs.ac.uk/collections/bgsgeology625kdykes?f=json"
url = "https://ogcapi.bgs.ac.uk/collections/bgsgeology625kdykes/items?f=json&offset=0"

BGS = Namespace("http://data.bgs.ac.uk/id/")
GEOLOGY_MAP_DATASET = BGS.geology625k
FEATURE_COLLECTION_IRI = URIRef("http://data.bgs.ac.uk/id/geology625k/dykes")
...
def generate():
    ...
    graph.serialize(
        "spatial/geologymap/dykes-feature-collection.ttl", format="longturtle"
    )
