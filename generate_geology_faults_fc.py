...
dataset_json_url = "https://ogcapi.bgs.ac.uk/collections/bgsgeology625kfaults?f=json"
url = "https://ogcapi.bgs.ac.uk/collections/bgsgeology625kfaults/items?f=json&offset=0"
...
def generate():
    ...
    graph.serialize(
        "spatial/geologymap/faults-feature-collection.ttl", format="longturtle"
    )
